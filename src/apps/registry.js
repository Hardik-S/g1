...
export const APP_METADATA = [
  ...
  },
  {
    id: 'vibe-memory',
    title: 'Vibe Memory',
    description: 'Flip cards across lush gradients, chase best scores, and enjoy synthesized chimes.',
    icon: '✨',
    category: 'Games',
    component: null,
    loader: () => import('./VibeMemoryGameApp'),
    path: '/apps/vibe-memory',
    tags: ['game', 'memory', 'audio', 'react'],
    created: '2025-11-06',
    featured: true,
    version: '1.0.0',
  },
  {
    id: 'html-chess',
    title: 'HTML Chess Lab',
    description: 'Stream Stockfish 17 in the browser, attach NNUE networks, and experiment with UCI commands.',
    icon: '♞',
    category: 'Games',
    component: null,
    loader: () => import('./HtmlChessApp'),
    path: '/apps/html-chess',
    tags: ['chess', 'engine', 'uci', 'stockfish'],
    created: '2025-10-30',
    featured: true,
    version: '1.0.0',
  },
  {
    id: 'claude-chess',
    title: 'Claude Chess',
    description: 'Battle Stockfish inside a Claude-themed arena with glowing board highlights.',
    icon: '♚',
    category: 'Games',
    component: null,
    loader: () => import('./ClaudeChessApp'),
    path: '/apps/claude-chess',
    tags: ['chess', 'stockfish', 'ai', 'board-game'],
    created: '2025-11-01',
    featured: true,
    version: '1.0.0',
  },
  ...
  },
  {
    id: 'namecraft',
    title: 'Namecraft',
    description: 'Design rooms, craft candidate names, and run deterministic heuristics for linguistics cohorts.',
    icon: '🔤',
    category: 'Tools',
    component: null,
    loader: () => import('./NamecraftApp'),
    path: '/apps/namecraft',
    tags: ['naming', 'linguistics', 'analysis'],
    created: '2025-01-12',
    featured: true,
    version: '1.0.0',
  },
  ...
  {
    id: 'relational-algebra-playground',
    title: 'Relational Algebra Playground',
    description: 'Build relational algebra pipelines, inspect intermediate tables, and translate to SQL in real time.',
    icon: '🧠',
    category: 'Education',
    component: null,
    loader: () => import('./RelationalAlgebraPlaygroundApp'),
    path: '/apps/relational-algebra-playground',
    tags: ['databases', 'education', 'sql', 'visual'],
    created: '2025-10-24',
    featured: true,
    version: '1.0.0',
  },
  ...
  },
  {
    id: 'snake-2',
    title: 'Snake 2.0',
    description: 'A lush creative redesign with neon, garden, and minimal themes plus new game modes.',
    icon: '🌀',
    category: 'Games',
    component: null,
    loader: () => import('./SnakeCreativeApp'),
    path: '/apps/snake-2',
    tags: ['game', 'canvas', 'snake', 'multiplayer'],
    created: '2025-10-30',
    featured: true,
    version: '1.0.0',
  },
  ...
  },
  {
    ...
    description: 'Translate natural language music requests into relational algebra and inspect execution steps.',
    icon: '🎶',
    category: 'Education',
    component: null,
    loader: () => import('./playlist-curator'),
    path: '/apps/playlist-curator',
    tags: ['music', 'relational-algebra', 'education', 'nlp'],
    created: '2025-10-26',
    featured: true,
    version: '1.0.0',
  },
